...
//@Autonomous(name="tnemngilAnoceaB", group="MyGroup")
public class tnemngilAnoceaB extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive()) {
            ...
            /*
            driveForTicks(1500, -.5);

            sleep(500);

            turnDegrees(startingDegrees - gyro.getIntegratedZValue() + 90);
    ...
    public void runForEnc(int ticks, double power) {
        ...
        while(getAllDriveEncAvg() <= ticks && opModeIsActive()) {
    ...
    public void strafeStraightLeft() {
        ...
        powerFL += -turnCorrection;
        powerFR += turnCorrection;
        powerBL += -turnCorrection;
        powerBR += turnCorrection;
    ...
    public void turnDegrees(int degrees) {
        ...
        while (Math.abs(gyro.getIntegratedZValue() - initialHeading - degrees) >= TURN_DEG_TOLERANCE && opModeIsActive()) {
            ...
            else if (Math.abs(power) > .7 && power != 0) {
                power = 0.7 * (power / Math.abs(power));
            }
        ...
        for (VuforiaTrackable beac : beacons) {
            ...
            if (pose != null) {
                ...
                while((Math.abs(xDistance - targetX)) > X_ALIGNMENT_TOLERANCE && opModeIsActive()) {
                    ...
                    if (Math.abs(alignmentPower) < 0.08 && alignmentPower != 0) {
                        alignmentPower = 0.08 * (alignmentPower / Math.abs(alignmentPower));
                    }
    ...
    public void readImageX() {
        ...
        for (VuforiaTrackable beac : beacons) {
            ...
            if (pose != null) {
                ...
                while((runTime.time() - timeMark) < 5000 && opModeIsActive()) {
